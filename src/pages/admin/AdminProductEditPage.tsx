  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (isEdit && id) {
        ...
        // Also invalidate the individual product cache
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <textarea
              ...
              defaultValue={productData?.descriptionHtml || ""}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-2">
              <select
                ...
                defaultValue={productData?.categoryId?._id || ""}
              >
          ...
          <div>
            ...
            <input
              ...
              required
              className={inputClass}
              defaultValue={productData?.priceMrp || ""}
            />
            {formErrors.priceMrp && (
          ...
          <div>
            ...
            <input
              ...
              required
              className={inputClass}
              defaultValue={productData?.priceSell || ""}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <input
              ...
              min="0"
              className={inputClass}
              defaultValue={productData?.stockQty || 0}
            />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">
            ...
            <input
              ...
              min="0"
              className={inputClass}
              defaultValue={productData?.lowStockThreshold || 10}
            />
          </div>
          <div className="flex items-end gap-6">
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="isActive"
                defaultChecked={productData?.isActive !== false}
              />
            ...
            <label className="inline-flex items-center gap-2">
              <input
                type="checkbox"
                name="isFeatured"
                defaultChecked={productData?.isFeatured || false}
              />
